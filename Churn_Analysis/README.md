...
The dataset used for this project is a telecommunications customer database and contains a range of attributes describing customer demographics, service usage, and billing patterns. It was
obatained from DataCamp.
...
This project demonstrates how customer data can be used to uncover churn drivers, quantify financial impact, and identify opportunities to improve retention.

By applying data-driven insights to customer management strategies, businesses can better protect revenue and strengthen long-term customer relationships.
